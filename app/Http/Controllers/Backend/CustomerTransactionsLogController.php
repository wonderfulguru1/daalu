...
class CustomerTransactionsLogController extends Controller
{
    ...
    {
        $customerTransactionsLogs = CustomerTransactionsLog::where(['transaction'=>$type])->paginate();

        return view(theme('customer-transactions-log.index'), compact('customerTransactionsLogs'))
    ...
    public function create()
    {
        ...
        return view(theme('customer-transactions-log.create'), compact('customerTransactionsLog'));
    }
    ...
    public function show($id)
    {
        ...
        return view(theme('customer-transactions-log.show'), compact('customerTransactionsLog'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(theme('customer-transactions-log.edit'), compact('customerTransactionsLog'));
    }
